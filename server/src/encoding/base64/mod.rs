...
pub fn encode(data: &[u8]) -> Vec<u8> {
    ...
    let bytes_written = base64::encode_config_slice(data, base64::STANDARD, &mut encoded);
...
pub fn decode(data: &[u8]) -> Result<Vec<u8>, base64::DecodeError> {
    ...
    let bytes_written = base64::decode_config_slice(data, base64::STANDARD, &mut decoded)?;
