...
impl DB {
    ...
    pub fn insert_post<'a, N: Into<posts::NewWithId<'a>>>(&self, new: N) -> Result<posts::Data, diesel::result::Error> {
...
impl DB {
    ...
    pub fn create_user<'a, N: Into<users::NewWithId<'a>>>(&self, new_user: N) -> Result<users::Data, diesel::result::Error> {
...
impl DB {
    ...
    pub fn find_pw_by_id(&self, id: uuid::Uuid) ->  Result<credentials::pw::Data, diesel::result::Error> {
        schema::passwords::table
            .find(id)
            .get_result(self.conn())
    }
